...
import jabberwocky.wordBased.Jabberwocky;
import jabberwocky.wordBased.abstractClasses.Controller;
...
public class Splash_Controller extends Controller<Splash_Model, Splash_View> {
    ...
    public Splash_Controller(final Jabberwocky main, Splash_Model model, Splash_View view) {
        super(model, view);
