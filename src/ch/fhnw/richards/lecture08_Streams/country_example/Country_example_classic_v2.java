package ch.fhnw.richards.lecture08_Streams.country_example;

import java.util.ArrayList;
import java.util.Collections;

public class Country_example_classic_v2 {
	...
	private static ArrayList<String> getNames_SmallCountries(ArrayList<Country> countries) {
		...
		Collections.sort(smallCountries, (c1, c2) -> c1.getName().compareTo(c2.getName()));
