package ch.fhnw.richards.lecture14_Messaging.serialization.server;
...
public class ServerView {
    ...
    protected ServerView(Stage stage, ServerModel model, TextArea txtLog) {
        this.stage = stage;
        this.model = model;
        this.txtLog = txtLog;
        
        stage.setTitle("Java object message server");
