package ch.fhnw.richards.lecture14_Messaging.simpleXML.client;
...
public class ClientView {
    ...
    protected Button btnNewCustomer = new Button("New customer");
    ...
    protected ClientView(Stage stage, ClientModel model) {
        ...
        bottomBox.getChildren().addAll(btnHello, btnNewCustomer, spacer, btnGoodbye);
        HBox.setHgrow(spacer, Priority.ALWAYS);
